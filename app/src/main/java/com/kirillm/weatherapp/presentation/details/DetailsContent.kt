...
import com.kirillm.weatherapp.presentation.formattedFullDate
import com.kirillm.weatherapp.presentation.formattedShortDayOfWeek
    ...
    Scaffold(
        ...
        topBar = {
            TopBar(
                ...
                onClickChangeFavouriteStatus = { component.onFavouriteClick() }
            )
        },
        modifier = Modifier
            .fillMaxSize()
