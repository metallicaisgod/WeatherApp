...
import com.kirillm.weatherapp.presentation.search.SearchStore.Intent
import com.kirillm.weatherapp.presentation.search.SearchStore.Label
import com.kirillm.weatherapp.presentation.search.SearchStore.State
...
class SearchStoreFactory @Inject constructor(
    ...
    fun create(searchReason: SearchReason): SearchStore =
